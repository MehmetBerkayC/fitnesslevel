...
export default function ExerciseCard(props) {
	...
	return (
		<div className="p-4 bg-slate-950 rounded-md flex flex-col gap-4 sm:flex-wrap">
			<div className="flex flex-col sm:flex-wrap sm:flex-row sm:items-center gap-x-4">
			...
			<div className="flex flex-col bg-slate-950 rounded gap-2 ">
				{exercise.description.split("___").map((value) => {
			...
			<div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
				...
				<button
					...
					className="flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-sky-900 hover:border-sky-600 w-full"
				>
